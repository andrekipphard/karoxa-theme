						...
						<div class="col">
							...
							<div class="row">
								...
								<div class="col-12 col-lg-6 d-flex flex-column justify-content-center">
									...
									<p>Nach deiner Anmeldung erhältst du einen einmaligen Gutschein im Wert von 20% für unseren Shop.</p>
									...
									<div id="mc_embed_signup">
										<form action="https://shop.us14.list-manage.com/subscribe/post?u=3cdaf883709240a5a7d5313a0&amp;id=c3dc59dd4b&amp;f_id=003692e0f0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate d-flex justify-content-center flex-column" target="_blank" novalidate>
											<div id="mc_embed_signup_scroll mb-4 mt-2 d-flex justify-content-center align-self-center">
												<div class="mc-field-group d-flex flex-column justify-content-center align-items-center">
													<input type="email" value="" name="EMAIL" class="popup-input footer-newsletter-input required email align-self-center" id="mce-EMAIL" placeholder="E-mail Adresse" required>
